...
def pytest_generate_tests(metafunc):
    ...
    if 'configuration' in metafunc.fixturenames:
        metafunc.parametrize("configuration", [json.loads('{"port":3000,"editor":{"mode":"vscode","agent":"gitpod","version":"1.0.72"},"dirPath":"./.learn","configPath":"learn.json","outputPath":".learn/dist","publicPath":"/preview","publicUrl":"https://3000-tommygonzaleza-numpy100-qo6ylosgb96.ws-us34.gitpod.io","language":"auto","grading":"incremental","exercisesPath":".learn/exercises","webpackTemplate":null,"disableGrading":false,"disabledActions":[],"actions":[],"entries":{"html":"index.html","vanillajs":"index.js","react":"app.jsx","node":"app.js","python3":"app.py","java":"app.java"},"address":"https://tommygonzaleza-numpy100-qo6ylosgb96.ws-us34.gitpod.io","difficulty":"intermediate","duration":10,"description":"","title":"Numpy Exercises","slug":"numpy-exercises","session":1783393130656623000,"translations":[]}')])
