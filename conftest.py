...
def pytest_generate_tests(metafunc):
    ...
    if 'configuration' in metafunc.fixturenames:
        metafunc.parametrize("configuration", [json.loads('{"port":3000,"editor":{"mode":"vscode","agent":"gitpod","version":"1.0.72"},"dirPath":"./.learn","configPath":"learn.json","outputPath":".learn/dist","publicPath":"/preview","publicUrl":"https://3000-tommygonzaleza-numpy100-r147spuvpab.ws-us34.gitpod.io","language":"auto","grading":"incremental","exercisesPath":".learn/exercises","webpackTemplate":null,"disableGrading":false,"disabledActions":[],"actions":[],"entries":{"html":"index.html","vanillajs":"index.js","react":"app.jsx","node":"app.js","python3":"app.py","java":"app.java"},"difficulty":"beginner","duration":1,"description":"","title":"My Interactive Tutorial","slug":"my-interactive-tutorial","translations":[]}')])
